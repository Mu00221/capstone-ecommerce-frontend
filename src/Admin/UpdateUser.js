...
function UpdateUser(props) {
  ...
  <div class="col " id="grid">
    ...
    <input type="text" class="form-control" placeholder=" State" name="state" onChange={onChangeHandler} value={updateUser.state}/>
  ...
  <input type="text" class="form-control" placeholder="Phone Number" name="phone" onChange={onChangeHandler} value={updateUser.phone}/>
   <input type="text" class="form-control" placeholder="Profile Photo" name="profile" onChange={onChangeHandler} value={updateUser.photo}/>
   <input type="password" class="form-control" placeholder=" User Status Code!" name="code" onChange={onChangeHandler} value={updateUser.code}/>
